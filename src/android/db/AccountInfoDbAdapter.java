...
public interface AccountInfoDbAdapter {
  ...
  public static final String DATABASE_NAME = "sitescope.db";
  public static final String DATABASE_TABLE = "INSTANCES";
  ...
  public static final String FAVES_DATABASE_CREATE =
    "create table IF NOT EXISTS "+FAVES_DATABASE_TABLE+" ("
      + KEY_ROWID + " INTEGER, "
      + PARENT_ID + " VARCHAR, "
      + NAME + " VARCHAR, "
      + UPDATE_DATE+ " VARCHAR, "
